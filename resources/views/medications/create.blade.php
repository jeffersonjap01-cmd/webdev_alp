...
@section('title', 'Tambah Obat - VetCare')

@section('page-title', 'Tambah Obat')
@section('page-description', 'Tambahkan obat baru untuk resep')
        ...
        <div class="px-4 py-5 sm:p-6">
            ...
            <form action="{{ route('medications.store') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <select name="prescription_id" id="prescription_id" required
                        ...
                        @foreach($prescriptions as $prescription)
                            <option value="{{ $prescription->id }}" {{ old('prescription_id') == $prescription->id ? 'selected' : '' }}>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="frequency" id="frequency" required value="{{ old('frequency') }}"
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="duration" id="duration" required value="{{ old('duration') }}"
                ...
                <div class="mb-6">
                    ...
                    <textarea name="instructions" id="instructions" rows="4"
                              ...
                              placeholder="Instruksi tambahan untuk penggunaan obat...">{{ old('instructions') }}</textarea>
                    @error('instructions')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
