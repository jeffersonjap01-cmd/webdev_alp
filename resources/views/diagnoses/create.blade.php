...
@section('title', 'Tambah Diagnosis - VetCare')

@section('page-title', 'Tambah Diagnosis')
@section('page-description', 'Tambahkan diagnosis baru untuk rekam medis')
        ...
        <div class="px-4 py-5 sm:p-6">
            ...
            <form action="{{ route('diagnoses.store') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="diagnosis_name" id="diagnosis_name" required value="{{ old('diagnosis_name') }}"
                ...
                <div class="mb-6">
                    ...
                    <textarea name="description" id="description" rows="6"
                              ...
                              placeholder="Keterangan detail tentang diagnosis...">{{ old('description') }}</textarea>
                    @error('description')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
