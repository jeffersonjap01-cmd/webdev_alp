...
@section('page-description', 'Edit existing appointment')
        ...
        <div class="md:flex md:items-center md:justify-between">
            <div class="flex-1 min-w-0">
                ...
                <p class="mt-1 text-sm text-gray-600">
                    Update existing appointment information
                </p>
            </div>
            ...
            <form action="{{ route('appointments.update', $appointment) }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <textarea name="notes" id="notes" rows="3" 
                              ...
                              placeholder="Additional notes for this appointment">{{ old('notes', $appointment->notes) }}</textarea>
                    @error('notes')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
