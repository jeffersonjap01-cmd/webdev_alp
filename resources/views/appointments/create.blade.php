...
@section('page-title', 'Buat Janji Temu')
@section('page-description', 'Buat janji temu baru untuk hewan peliharaan')
        ...
        <div class="md:flex md:items-center md:justify-between">
            <div class="flex-1 min-w-0">
                ...
                <p class="mt-1 text-sm text-gray-600">
                    Isi form di bawah untuk membuat janji temu baru
                </p>
            </div>
            ...
            <form action="{{ route('appointments.store') }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <select name="service_type" id="service_type" required class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm rounded-md @error('service_type') border-red-300 @enderror">
                        ...
                        <option value="Dental Care" {{ old('service_type') == 'Dental Care' ? 'selected' : '' }}>Perawatan Gigi</option>
                        <option value="Surgery" {{ old('service_type') == 'Surgery' ? 'selected' : '' }}>Operasi</option>
                        <option value="Emergency" {{ old('service_type') == 'Emergency' ? 'selected' : '' }}>Gawat Darurat</option>
                ...
                <div>
                    ...
                    <textarea name="notes" id="notes" rows="3" 
                              ...
                              placeholder="Catatan tambahan untuk janji temu ini">{{ old('notes') }}</textarea>
                    @error('notes')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
