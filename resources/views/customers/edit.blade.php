...
<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="mb-6">
        <div class="flex items-center">
            <a href="{{ route('customers.show', $owner) }}" class="text-blue-600 hover:text-blue-800 mr-4">
                <i class="fas fa-arrow-left"></i>
            </a>
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Edit {{ $owner->name }}</h1>
    ...
    <div class="bg-white shadow rounded-lg">
        <form action="{{ route('customers.update', $owner) }}" method="POST" class="px-6 py-4">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                ...
                <div class="sm:col-span-2">
                    ...
                    <textarea name="address" id="address" rows="3"
                              ...
                              placeholder="Masukkan alamat lengkap">{{ old('address', $owner->address) }}</textarea>
                    @error('address')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="mt-6 flex justify-end space-x-3">
                <a href="{{ route('customers.show', $owner) }}"
