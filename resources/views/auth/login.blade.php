...
<div class="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8">
        ...
        <div class="mt-8 border-t border-gray-200 pt-6">
            <h3 class="text-sm font-medium text-gray-900 text-center mb-4">Akun Demo</h3>
            <div class="grid grid-cols-1 gap-3">
                <button onclick="fillDemoAccount('admin@vetcare.com', 'password')" class="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50">
                    <i class="fas fa-user-shield mr-2"></i>
                    Administrator
                </button>
                <button onclick="fillDemoAccount('vet@vetcare.com', 'password')" class="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50">
